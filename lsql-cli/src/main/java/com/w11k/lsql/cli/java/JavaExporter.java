...
//    }
    ...
    public void export() {
        List<TableRowDataClassExporter> tableRowClassExporters = Lists.newLinkedList();
        ...
        for (TableLike cc : tables) {
            ...
            TableRowDataClassExporter rowClassExporter = new TableRowDataClassExporter(this.lSql, cc, this);
...
*/
        ...
        for (TableRowDataClassExporter tableRowClassExporter : tableRowClassExporters) {
