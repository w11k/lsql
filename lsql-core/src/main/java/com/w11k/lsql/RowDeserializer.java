...
public interface RowDeserializer<T> {
    ...
    class DirectRowDeserializer implements RowDeserializer<Row> {
        ...
        @Override
        public void deserializeField(LSql lSql, Row row, Converter converter, String internalSqlColumnName, ResultSet resultSet, int resultSetColumnPosition) throws Exception {
